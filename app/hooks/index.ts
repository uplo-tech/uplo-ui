...
// this file maps out common hooks that will be used by Uplo-UI. At the moment we
...
// move Uplo-UI to a full-hooks model, as it's quite easier to work with
// react-hooks when prototyping than with react-redux + sagas.

// define the actions used by the reducer for uplod requests
const actions = {
