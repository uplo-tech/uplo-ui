...
const initialTermState =
  'Welcome to the Uplo Terminal! Type `help` to see the available commands. Type `clear` to clear the screen.\n\n'
        ...
        <Input
          ...
          onPressEnter={async (e: any) => {
            ...
            try {
              ...
              setState(`Error executing uploc. Please contact the developers for help. ${e}`)
            }
          }}
        />
      </StyledModal>
