    ...
    return (
      <Form layout="vertical">
        <Form.Item label="Generated Seed">
          <Tooltip
            placement="bottom"
            title="Please keep your seed backed up somewhere secure. Your seed is used to create your private key. Anyone with access to your private key has full access to your UploCoin funds."
          >
