        ...
        <TextInputGroup
          ...
          suffix={
            <Flex alignItems="center">
              <StyledTag>UPLO</StyledTag>
              <Tooltip placement="right" title="Amount of UploCoins you'd like to spend for the period.">
      ...
      <TextInputGroup
        ...
        suffix={
          <Flex alignItems="center">
            ...
            <Tooltip
              placement="right"
              title="Number of months prior to contract expiration that Uplo will attempt to renew your contracts."
            >
              <StyledIcon type="info-circle" />
            </Tooltip>
          </Flex>
