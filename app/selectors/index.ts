...
export const selectSiadState = (state: IndexState) => state.ui.uplod
...
export const selectSpending = createSelector(
  ...
  contracts => {
    ...
    let siaadspending = new BigNumber(0)
    ...
    contracts.activecontracts.forEach(c => {
      ...
      siaadspending = new BigNumber(c.siaadspending).plus(siaadspending)
    ...
    return {
      ...
      siaadspending: toSiacoins(siaadspending).toFixed(2),
