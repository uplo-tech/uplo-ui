...
export namespace UIReducer {
  ...
  const SiadReducer = reducerWithInitialState(InitialSiadState)
    .case(GlobalActions.uplodLoaded, (state, _) => {
      return {
        ...state,
        isActive: true,
        loading: false
    ...
    .case(GlobalActions.uplodOffline, (state, _) => {
      return {
        ...state,
        isActive: false,
        loading: false
    ...
    .case(GlobalActions.uplodLoading, (state, _) => {
      return {
        ...state,
        isActive: false,
        loading: true
    ...
    .case(GlobalActions.uplodAppendLog, (state, payload) => ({
      ...state,
      stdout: [...state.stdout, payload]
    }))
    .case(GlobalActions.uplodAppendErr, (state, payload) => ({
      ...state,
