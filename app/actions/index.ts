...
export namespace GlobalActions {
  ...
  export const uplodLoading = globalActionCreator<void>('SIAD_LOADING')
  export const uplodLoaded = globalActionCreator<void>('SIAD_LOADED')
  export const uplodOffline = globalActionCreator<void>('SIAD_OFFLINE')
  export const setSiadOrigin = globalActionCreator<{ isInternal: boolean }>('SET_SIAD_ORIGIN')

  // append log from the uplod process
  export const uplodAppendLog = globalActionCreator<string>('SIAD_LOG')
  export const uplodAppendErr = globalActionCreator<string>('SIAD_ERR')
