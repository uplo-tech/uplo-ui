...
class Dashboard extends React.Component<StateProps, {}> {
  openDocs = () => {
    shell.openExternal('https://uplo.tech/docs/')
  }
  render() {
                ...
                <Flex alignItems="center" justifyContent="center" flexDirection="column" pb={3}>
                  ...
                  <Box width={3 / 5} style={{ textAlign: 'center' }}>
                    <Text is="div" fontSize={2} py={2} fontWeight={400}>
                      Uplo is the leading decentralized cloud storage platform. Private, robust,
                      and affordable, Uplo is great for backups and video streaming. Build your
                      app on Uplo today!
                    </Text>
                  </Box>
                </Flex>
