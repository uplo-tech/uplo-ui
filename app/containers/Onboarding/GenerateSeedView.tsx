    ...
    <Box>
      <Card mb={4}>
        <Flex alignItems="center">
          ...
          <Box>
            <Text fontSize={2}>
              This is your Uplo seed. It is your wallet password until you change it. Please
              copy and store your seed somewhere safe, because there's no way to recover it.
              Your seed is used to unlock your wallet and can recover your UploCoins and uploaded files.
            </Text>
            <Box pt={2}>
