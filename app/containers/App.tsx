...
import { launchSiad, uplod, setGlobalSiadProcess, getGlobalSiadProcess } from 'api/uplod'
...
export const GlobalStyle = createGlobalStyle`
  ...
  .ant-modal-confirm-warning .ant-modal-confirm-body > .anticon, .ant-modal-confirm-confirm .ant-modal-confirm-body > .anticon {
    color: ${themeGet('colors.uplo-green')} !important;
  }
...
class App extends React.Component<DispatchProp> {
  componentDidMount = async () => {
    ...
    setTimeout(async () => {
      if (!isRunning) {
        dispatch(GlobalActions.uplodLoading())
        try {
